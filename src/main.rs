...
fn main() -> Result<(), String> {
    ...
    let window = video_subsystem.window("Cell Life", WIDTH as u32, HEIGHT as u32)
        .position_centered()
        .allow_highdpi()
        .resizable()
        .allow_highdpi()
    ...
    canvas.set_logical_size(WIDTH as u32, HEIGHT as u32).expect("Logical Size Error");
    ...
    'running: loop {
        ...
        canvas.fill_rect(Rect::new(0,0,640, 640))?;
        ...
        //let end = Instant::now();
        //println!("{}", 1000 / (end - begining).as_millis());
